...
def ensure_files() -> None:
    ...
    if not TEMPLATE_PATH.exists():
        TEMPLATE_PATH.write_text(
            "Hi {{hr_name}},\n\n"
            "I am writing to express my strong interest in the Salesforce position. Below, I have included a brief overview of my qualifications:\n\n"
            "* Five years of experience in Salesforce development\n"
            "* Proficient in Lightning Web Components, Sales Cloud, Service Cloud, FSC, Apex triggers, CPQ, and integrations\n\n"
            "I would like to know when it would be convenient for you to have a discussion regarding this opportunity.\n\n"
            "Best,\n"
            "Saketh Reddy Chintala\n"
            "+1 571 541 6433 || [sakethredd04@gmail.com](mailto:sakethredd04@gmail.com)\n"
            "https://www.linkedin.com/in/saketh-ch-a478092b0/\n",
            encoding="utf-8",
        )
...
def send_email(
    ...
    del (
        ...
        company,
        position,
    )  # kept for signature compatibility and feature parity
...
def render_body(
    ...
    del cfg, company, position
    safe_hr_name = (hr_name or "").strip() or "Hiring Team"
    return template.replace("{{hr_name}}", safe_hr_name).replace("{hr_name}", safe_hr_name)
